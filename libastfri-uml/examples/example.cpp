...
int main()
{
    ...
    // auto classDSTwo = statements.mk_class_def("ClassName");
    // classDSTwo->vars_ = vars;
    // classDSTwo->methods_ = funcmems;
    // classDSTwo->tparams_ = tparams;
    ...
    // auto tu = statements.mk_translation_unit();
    // tu->classes_ = classes;
    // tu->functions_ = functions;
    // tu->globals_ = globals;
