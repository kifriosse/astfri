...
#include <astfri-serialize/Data.hpp>
...
private:
    ...
    // key is name of unresolved class or interface def statement,value is vector of class or
    // interface def statements,which innherit or implement that unresolved Class/Interface
    ...
    astfri::MethodDefStmt* deserialize_method_def_stmt(
        rapidjson::Value& value,
        astfri::UserTypeDefStmt* owner = nullptr
    );
