...
// TODO namiesto tychto su uz enumy v astfri-core
enum ExprNodeType {
    IntLiteralExpr,
    FloatLiteralExpr,
    CharLiteralExpr,
...
inline std::unordered_map<std::string, ExprNodeType> strToExprMapping = {
    {"IntLitExpr",          IntLiteralExpr     },
    {"FloatLitExpr",        FloatLiteralExpr   },
    {"CharLitExpr",         CharLiteralExpr    },
    {"StringLitExpr",       StringLiteralExpr  },
    {"BoolLitExpr",         BoolLiteralExpr    },
    {"NullLitExpr",         NullLiteralExpr    },
    {"IfExpr",              IfExpr             },
    {"BinOpExpr",           BinOpExpr          },
    {"UnaryOpExpr",         UnaryOpExpr        },
    {"ParamVarRefExpr",     ParamVarRefExpr    },
    {"LocalVarRefExpr",     LocalVarRefExpr    },
    {"MemberVarRefExpr",    MemberVarRefExpr   },
    {"GlobalVarRefExpr",    GlobalVarRefExpr   },
    {"FunctionCallExpr",    FunctionCallExpr   },
    {"MethodCallExpr",      MethodCallExpr     },
    {"LambdaExpr",          LambdaExpr         },
    {"ThisExpr",            ThisExpr           },
    {"UnknownExpr",         UnknownExpr        },
    {"ConstructorCallExpr", ConstructorCallExpr},
    {"NewExpr",             NewExpr            },
    {"DeleteExpr",          DeleteExpr         },
    {"ClassRefExpr",        ClassRefExpr       },
    {"LambdaCallExpr",      LambdaCallExpr     }
};

inline std::unordered_map<std::string, StmtNodeType> strToStmtMapping = {
    ...
    {"DestructorDefStmt",   DestructorDefStmt  },
...
inline std::unordered_map<std::string, astfri::BinOpType> binOpTypeMapping = {
    ...
    {"//=", astfri::BinOpType::FloorDivideAssign   },
    {"%=",  astfri::BinOpType::ModuloAssign        },
    {"**=", astfri::BinOpType::ExponentiationAssign},
    {">>=", astfri::BinOpType::BitShiftRightAssign },
    {"&=",  astfri::BinOpType::BitAndAssign        },
    {"|=",  astfri::BinOpType::BitOrAssign         },
    {"^=",  astfri::BinOpType::BitXorAssign        },
    {"//",  astfri::BinOpType::FloorDivide         },
    {"**",  astfri::BinOpType::Exponentiation      },
    {"<<=", astfri::BinOpType::BitShiftLeftAssign  },
};

// if it s post increment/decrement operator is solved in serialize_unary_expr-there is property to
// recognise,which says if its post or pre increment/decrement type
inline std::unordered_map<std::string, astfri::UnaryOpType> unaryOpTypeMapping = {
    {"-",  astfri::UnaryOpType::Minus       },
    {"+",  astfri::UnaryOpType::Plus        },
    {"*",  astfri::UnaryOpType::Dereference },
    {"&",  astfri::UnaryOpType::AddressOf   },
...
inline std::unordered_map<std::string, Types> strToTypeMapping = {
    {"IntType",         IntType        },
    {"FloatType",       FloatType      },
    {"CharType",        CharType       },
    {"BoolType",        BoolType       },
...
inline std::unordered_map<std::string, astfri::AccessModifier> accessModMapping = {
