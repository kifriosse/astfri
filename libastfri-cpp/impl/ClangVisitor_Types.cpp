...
clang::BuiltinType::Kind get_clang_type_from_builtin(clang::BuiltinType const* builtin)
{
    // malo by prejst vzdy
    ...
    {
        // vraciam specificky char8, lebo nieje obycajny char, len jeho podtypy, tak som si vybral
        // char8
...
astfri::Type* ClangVisitor::get_astfri_type_from_clang_builtintype(clang::BuiltinType const* builtin
)
{
...
astfri::Type* ClangVisitor::get_astfri_pointee(clang::PointerType const* pointer)
{
