...
namespace astfri::text
{
    ...
    public:
        ASTTextVisitor(const ASTTextVisitor&) = delete;
        ASTTextVisitor(ASTTextVisitor&&)      = delete;
        ASTTextVisitor& operator=(const ASTTextVisitor&) = delete;
    ...
    private:
        ...
        void write_initialization(const VarDefStmt* var);
        ...
        void write_var_def(const VarDefStmt& var, int vartype);
        void write_template_head(const std::vector<GenericParam*>& vgen);
        ...
        template <typename VRelation>
        void write_relations(const VRelation& vrel, bool ispolym);
    };

    //template <Vector_of_Relations VRelation>
    template <typename VRelation>
    void ASTTextVisitor::write_relations(const VRelation& vrel, bool ispolym)
    {
