...
public:
    ...
    void write_separator(const std::string& sep) override    = 0;
    void write_right_bracket(const std::string& br) override = 0;
    void write_left_bracket(const std::string& br) override  = 0;
    void write_opening_curl_bracket() override;
    void write_opening_else_word() override;
    // OPERATORS
    virtual void write_operator(const std::string& op) = 0;
    ...
    virtual void write_class_type(const std::string& name)     = 0;
    virtual void write_interface_type(const std::string& name) = 0;
    // REFERENCE_NAMES
    virtual void write_scope_name(const std::string& name)      = 0;
    virtual void write_gen_param_name(const std::string& name)  = 0;
    virtual void write_class_name(const std::string& name)      = 0;
    virtual void write_interface_name(const std::string& name)  = 0;
    virtual void write_method_name(const std::string& name)     = 0;
    virtual void write_function_name(const std::string& name)   = 0;
    virtual void write_global_var_name(const std::string& name) = 0;
    virtual void write_member_var_name(const std::string& name) = 0;
    virtual void write_local_var_name(const std::string& name)  = 0;
    virtual void write_param_var_name(const std::string& name)  = 0;
    // VALUES
    ...
    void write_string_val(const std::string& val) override = 0;
