...
namespace astfri::text
{
    ...
    public:
        ...
        void write_oparator(std::string_view op) override;
        ...
        void write_class_type(std::string_view name) override;
        void write_interface_type(std::string_view name) override;
        // REFERENCE_NAMES
        void write_scope_name(std::string_view name) override;
        void write_gen_param_name(std::string_view name) override;
