...
void load_ast_tree_1(TreeVisitor& tv)
{
    ...
    idsStack->methods_
        = {std::move(sfc.mk_method_def(
               ...
               std::move(sfc.mk_function_def(
                   "push",
                   {std::move(sfc.mk_param_var_def("element", std::move(tfc.mk_user("T")), {}))},
           ...
           std::move(sfc.mk_method_def(
               {},
               std::move(sfc.mk_function_def("pop", {}, std::move(tfc.mk_user("T")), {})),
               std::move(AccessModifier::Public),
               std::move(Virtuality::Virtual)
           ))};
    //------------------------------------------------
    ...
    ext->tparams_     = {std::move(sfc.mk_generic_param("", "T"))};
    ...
    cdsImplStack->constructors_
        = {std::move(sfc.mk_constructor_def(
               ...
               {std::move(sfc.mak_base_initializer(
                   "ADS<T>",
                   {std::move(efc.mk_new(
                       std::move(efc.mk_constructor_call(std::move(tfc.mk_user("amt::IS<T>")), {}))
                   ))}
               ))},
               {},
               std::move(AccessModifier::Public)
    ...
    cdsImplStack->methods_ = {
        std::move(sfc.mk_method_def(
            ...
            std::move(sfc.mk_function_def(
                ...
                {std::move(sfc.mk_param_var_def("element", std::move(tfc.mk_user("T")), {}))},
                std::move(tfc.mk_void()),
                std::move(sfc.mk_compound({std::move(sfc.mk_expr(std::move(efc.mk_bin_on(
                    std::move(efc.mk_member_var_ref(
                        std::move(efc.mk_method_call(
                            std::move(
                                efc.mk_method_call(std::move(efc.mk_this()), "getSequence", {})
                            ),
                            "insertLast",
                            {}
                        )),
        ...
        std::move(sfc.mk_method_def(
            ...
            std::move(sfc.mk_function_def(
                ...
                std::move(sfc.mk_compound(
                    {std::move(sfc.mk_if(
                         std::move(efc.mk_method_call(std::move(efc.mk_this()), "isEmpty", {})),
                ...
                std::move(sfc.mk_compound(
                    {std::move(sfc.mk_if(
                     ...
                     std::move(sfc.mk_expr(std::move(efc.mk_method_call(
                         std::move(efc.mk_method_call(std::move(efc.mk_this()), "getSequence", {})),
                         "removeLast",
                         {}
                     )))),
        ...
        std::move(sfc.mk_method_def(
            ...
            std::move(sfc.mk_function_def(
                ...
                std::move(sfc.mk_compound({std::move(sfc.mk_return(std::move(efc.mk_unknown())))}))
            )),
    ...
    ext2->tparams_     = {std::move(sfc.mk_generic_param("", "T"))};
    ...
    cdsExplStack->constructors_
        = {std::move(sfc.mk_constructor_def(
               ...
               {std::move(sfc.mak_base_initializer(
                   "ADS<T>",
                   {std::move(efc.mk_new(std::move(
                       efc.mk_constructor_call(std::move(tfc.mk_user("amt::SinglyLS<T>")), {})
                   )))}
               ))},
               {},
               std::move(AccessModifier::Public)
