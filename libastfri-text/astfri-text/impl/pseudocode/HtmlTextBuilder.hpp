...
{
    class HtmlTextBuilder : public PseudocodeBuilder
    {
        std::string m_htmlString;
        int m_maxBracketIndex;
        int m_currentBrIndex;
    public:
        explicit HtmlTextBuilder(Config const& config);
        //
    ...
    private:
        // WRAPPING_CLASSES
        void use_unknown_phrase_style(std::string_view phrase);
        void use_operator_style(std::string_view op);
        void use_separator_style(std::string_view sep);
        void use_numeric_value_style(std::string_view val);
        void use_string_value_style(std::string_view val);
        void use_ref_name_style(std::string_view name);
        void use_var_ref_name_style(std::string_view name);
        void use_access_mod_style(std::string_view accmod);
        void use_numeric_type_style(std::string_view datatype);
        void use_string_type_style(std::string_view datatype);
        void use_system_type_style(std::string_view datatype);
        void use_object_phrase_style(std::string_view phrase);
        void use_condition_phrase_style(std::string_view phrase);
        void use_loop_phrase_style(std::string_view phrase);
        void use_other_phrase_style(std::string_view phrase);
        void use_support_phrase_style(std::string_view phrase);
    };
}
