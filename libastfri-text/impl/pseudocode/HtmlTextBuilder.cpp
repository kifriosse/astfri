...
void HtmlTextBuilder::write_separator(const std::string& sep) {
    write_separator_style(sep);
}

void HtmlTextBuilder::write_right_bracket(const std::string& br) {
...
void HtmlTextBuilder::write_left_bracket(const std::string& br) {
    if (configurator_->use_bracket_colors() && maxBracketIndex_ > 0) {
        std::string out = "<span style=\"br-color:";
        out.append(configurator_->bracket_colors()->at(currentBrIndex_).str());
        out.append("\">");
...
void HtmlTextBuilder::write_operator(const std::string& op) {
...
void HtmlTextBuilder::write_unknown_type() {
    std::string s
        = "<span class=\"unknown-type\">" + configurator_->unknown_type_word()->str() + "</span>";
    write_unavailable_style(s);
}

void HtmlTextBuilder::write_unknown_expr() {
    std::string s
        = "<span class=\"unknown-expr\">" + configurator_->unknown_expr_word()->str() + "</span>";
    write_unavailable_style(s);
}

void HtmlTextBuilder::write_unknown_stmt() {
    std::string s
        = "<span class=\"unknown-stmt\">" + configurator_->unknown_stmt_word()->str() + "</span>";
    write_unavailable_style(s);
}

void HtmlTextBuilder::write_invalid_type() {
    std::string s
        = "<span class=\"invalid-type\">" + configurator_->invalid_type_word()->str() + "</span>";
    write_unavailable_style(s);
}

void HtmlTextBuilder::write_invalid_expr() {
    std::string s
        = "<span class=\"invalid-expr\">" + configurator_->invalid_expr_word()->str() + "</span>";
    write_unavailable_style(s);
}

void HtmlTextBuilder::write_invalid_stmt() {
    std::string s
        = "<span class=\"invalid-stmt\">" + configurator_->invalid_stmt_word()->str() + "</span>";
    write_unavailable_style(s);
}
...
void HtmlTextBuilder::write_dynamic_type_word() {
    std::string s
        = "<span class=\"dynamic-word\">" + configurator_->dynamic_type_word()->str() + "</span>";
...
void HtmlTextBuilder::write_float_type_word() {
    std::string s
        = "<span class=\"float-word\">" + configurator_->float_type_word()->str() + "</span>";
    write_data_type_style(s);
}

void HtmlTextBuilder::write_char_type_word() {
    std::string s
        = "<span class=\"char-word\">" + configurator_->char_type_word()->str() + "</span>";
    write_data_type_style(s);
}

void HtmlTextBuilder::write_bool_type_word() {
    std::string s
        = "<span class=\"bool-word\">" + configurator_->bool_type_word()->str() + "</span>";
    write_data_type_style(s);
}

void HtmlTextBuilder::write_void_type_word() {
    std::string s
        = "<span class=\"void-word\">" + configurator_->void_type_word()->str() + "</span>";
    write_data_type_style(s);
}

void HtmlTextBuilder::write_class_type(const std::string& name) {
    std::string s = "<span class=\"class-type\">" + name + "</span>";
    write_data_type_style(s);
}

void HtmlTextBuilder::write_interface_type(const std::string& name) {
...
void HtmlTextBuilder::write_scope_name(const std::string& name) {
    std::string s = "<span class=\"scope-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_gen_param_name(const std::string& name) {
    std::string s = "<span class=\"gen-par-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_class_name(const std::string& name) {
    std::string s = "<span class=\"class-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_interface_name(const std::string& name) {
    std::string s = "<span class=\"interface-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_method_name(const std::string& name) {
    std::string s = "<span class=\"method-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_function_name(const std::string& name) {
    std::string s = "<span class=\"function-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_global_var_name(const std::string& name) {
    std::string s = "<span class=\"global-var-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_member_var_name(const std::string& name) {
    std::string s = "<span class=\"member-var-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_local_var_name(const std::string& name) {
    std::string s = "<span class=\"local-var-name\">" + name + "</span>";
    write_ref_name_style(s);
}

void HtmlTextBuilder::write_param_var_name(const std::string& name) {
...
void HtmlTextBuilder::write_int_val(const int& val) {
    std::string s = "<span class=\"int-value\">" + std::to_string(val) + "</span>";
    write_value_style(s);
}

void HtmlTextBuilder::write_float_val(const float& val) {
    std::string s = "<span class=\"float-value\">" + std::to_string(val) + "</span>";
    write_value_style(s);
}

void HtmlTextBuilder::write_char_val(const char& val) {
    std::string s = "<span class=\"char-value\">" + std::string(1, val) + "</span>";
    write_value_style(s);
}

void HtmlTextBuilder::write_string_val(const std::string& val) {
    std::string s = "<span class=\"string-value\">" + val + "</span>";
    write_value_style(s);
}

void HtmlTextBuilder::write_bool_val(const bool& val) {
...
void HtmlTextBuilder::write_null_val() {
    std::string s
        = "<span class=\"null-value\">" + configurator_->null_val_word()->str() + "</span>";
    write_value_style(s);
}
...
void HtmlTextBuilder::write_interface_word() {
    std::string s
        = "<span class=\"interface-word\">" + configurator_->interface_word()->str() + "</span>";
    write_system_expr_style(s);
}

void HtmlTextBuilder::write_implement_word() {
    std::string s
        = "<span class=\"implement-word\">" + configurator_->implement_word()->str() + "</span>";
    write_system_expr_style(s);
}

void HtmlTextBuilder::write_extend_word() {
    std::string s
        = "<span class=\"extend-word\">" + configurator_->extend_word()->str() + "</span>";
    write_system_expr_style(s);
}
...
void HtmlTextBuilder::write_return_word() {
    std::string s
        = "<span class=\"return-word\">" + configurator_->return_word()->str() + "</span>";
    write_system_expr_style(s);
}

void HtmlTextBuilder::write_continue_word() {
    std::string s
        = "<span class=\"continue-word\">" + configurator_->continue_word()->str() + "</span>";
    write_system_expr_style(s);
}
...
void HtmlTextBuilder::write_switch_word() {
    std::string s
        = "<span class=\"switch-word\">" + configurator_->switch_word()->str() + "</span>";
    write_system_expr_style(s);
}
...
void HtmlTextBuilder::write_default_word() {
    std::string s
        = "<span class=\"default-word\">" + configurator_->default_word()->str() + "</span>";
    write_system_expr_style(s);
}
...
void HtmlTextBuilder::write_delete_word() {
    std::string s
        = "<span class=\"delete-word\">" + configurator_->delete_word()->str() + "</span>";
    write_system_expr_style(s);
}

void HtmlTextBuilder::write_pointer_word() {
    std::string s
        = "<span class=\"pointer-word\">" + configurator_->pointer_word()->str() + "</span>";
    write_system_expr_style(s);
}

void HtmlTextBuilder::write_override_word() {
    std::string s
        = "<span class=\"override-word\">" + configurator_->override_word()->str() + "</span>";
    write_system_expr_style(s);
}

void HtmlTextBuilder::write_virtual_word() {
    std::string s
        = "<span class=\"virtual-word\">" + configurator_->virtual_word()->str() + "</span>";
    write_system_expr_style(s);
}

void HtmlTextBuilder::write_abstract_word() {
    std::string s
        = "<span class=\"abstract-word\">" + configurator_->abstract_word()->str() + "</span>";
    write_system_expr_style(s);
}

void HtmlTextBuilder::write_template_word() {
    std::string s
        = "<span class=\"template-word\">" + configurator_->template_word()->str() + "</span>";
    write_system_expr_style(s);
}
...
void HtmlTextBuilder::write_constructor_word() {
    std::string s
        = "<span class=\"constr-word\">" + configurator_->constructor_word()->str() + "</span>";
    write_other_expr_style(s);
}

void HtmlTextBuilder::write_destructor_word() {
    std::string s
        = "<span class=\"destr-word\">" + configurator_->destructor_word()->str() + "</span>";
    write_other_expr_style(s);
}

void HtmlTextBuilder::write_method_word() {
    std::string s
        = "<span class=\"method-word\">" + configurator_->method_word()->str() + "</span>";
    write_other_expr_style(s);
}

void HtmlTextBuilder::write_function_word() {
    std::string s
        = "<span class=\"function-word\">" + configurator_->function_word()->str() + "</span>";
    write_other_expr_style(s);
}

void HtmlTextBuilder::write_lambda_word() {
    std::string s
        = "<span class=\"lambda-word\">" + configurator_->lambda_word()->str() + "</span>";
    write_other_expr_style(s);
}
...
void HtmlTextBuilder::write_define_word() {
    std::string s
        = "<span class=\"define-word\">" + configurator_->define_word()->str() + "</span>";
    write_other_expr_style(s);
}

void HtmlTextBuilder::write_returns_word() {
    std::string s
        = "<span class=\"returns-word\">" + configurator_->returns_word()->str() + "</span>";
    write_other_expr_style(s);
}

void HtmlTextBuilder::write_repeat_word() {
    std::string s
        = "<span class=\"repeat-word\">" + configurator_->repeat_word()->str() + "</span>";
    write_system_expr_style(s);
}
...
void HtmlTextBuilder::write_unavailable_style(const std::string& phrase) {
    append_text("<span class=\"unavailable\">");
    append_text(phrase);
    append_text("</span>");
}

void HtmlTextBuilder::write_acc_mod_style(const std::string& accmod) {
    append_text("<span class=\"access-mod\">");
    append_text(accmod);
    append_text("</span>");
}

void HtmlTextBuilder::write_data_type_style(const std::string& datatype) {
    append_text("<span class=\"data-type\">");
    append_text(datatype);
    append_text("</span>");
}

void HtmlTextBuilder::write_ref_name_style(const std::string& name) {
    append_text("<span class=\"ref-name\">");
    append_text(name);
    append_text("</span>");
}

void HtmlTextBuilder::write_separator_style(const std::string& sep) {
    append_text("<span class=\"separator\">");
    append_text(sep);
    append_text("</span>");
}

void HtmlTextBuilder::write_operator_style(const std::string& op) {
    append_text("<span class=\"operator\">");
    append_text(op);
    append_text("</span>");
}

void HtmlTextBuilder::write_value_style(const std::string& val) {
    append_text("<span class=\"value\">");
    append_text(val);
    append_text("</span>");
}

void HtmlTextBuilder::write_system_expr_style(const std::string& expr) {
    append_text("<span class=\"system-expr\">");
    append_text(expr);
    append_text("</span>");
}

void HtmlTextBuilder::write_other_expr_style(const std::string& expr) {
