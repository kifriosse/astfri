...
void TextConfigurator::set_defaults() {
    // TEXT_FORMAT
    defaultTextStyle_  = std::make_unique<std::stringstream>("font-family:Consolas;font-size:18px");
...
void TextConfigurator::process_document(const rj::Value*& doc) {
    const rj::Value* textConf;
    // TEXT_CONFIGURATOR
...
void TextConfigurator::process_text_format(const rj::Value*& format) {
...
void TextConfigurator::process_code_structure(const rj::Value*& structure) {
...
void TextConfigurator::process_system_expressions(const rj::Value*& expr) {
    std::string stringVal;
...
void TextConfigurator::process_other_expressions(const rj::Value*& expr) {
    std::string stringVal;
