...
void ASTTextVisitor::write_initialization(const VarDefStmt* var)
{
    exporter_->write_space();
...
void ASTTextVisitor::write_generic_params_decl(const std::vector<GenericParam*>& vgeneric) {
...
void ASTTextVisitor::write_generic_params(const std::vector<GenericParam*>& vgeneric) {
    if (!configurator_->sh_generic_param()) {
        return;
    }
...
void ASTTextVisitor::write_var_def(const VarDefStmt& var, int vartype)
{
...
void ASTTextVisitor::write_template_head(const std::vector<GenericParam*>& vgen)
{
...
void ASTTextVisitor::write_member_var_decl(const std::vector<MemberVarDefStmt*>& vmembervars)
{
...
void ASTTextVisitor::write_constructor_decl(const std::vector<ConstructorDefStmt*>& vconstructors)
{
...
void ASTTextVisitor::write_destructor_decl(const std::vector<DestructorDefStmt*>& vdestructors)
{
...
void ASTTextVisitor::write_method_decl(const std::vector<MethodDefStmt*>& vmethods)
{
