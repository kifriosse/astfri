...
void Exporter::create_folder(std::string const& suffix)
{
...
void Exporter::write_word(std::string const& word)
{
...
void Exporter::write_round_bracket(std::string const& br)
{
    write_word(std::move(br));
}

void Exporter::write_curl_bracket(std::string const& br)
{
    write_word(std::move(br));
}
...
void Exporter::write_operator_sign(std::string const& sign)
{
...
void Exporter::write_separator_sign(std::string const& sign)
{
    write_word(std::move(sign));
}
